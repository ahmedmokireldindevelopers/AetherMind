...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side === "left" ? "left" : "right"} // Ensure side prop for SheetContent matches
          >
    ...
    return (
      <div
        ref={ref}
         // Use border-s/border-e for logical border properties
        ...
        <div
          className={cn(
            ...
            "group-data-[collapsible=offcanvas]:w-0",
             // Rotate based on side for proper visual transformation
            "group-data-[side=right]:order-last", // Ensures right sidebar appears last visually
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
         // Use start/end positioning based on side
        "absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-end-4 group-data-[side=right]:start-0 sm:flex",
        "[[dir=ltr]_&]:-translate-x-1/2 [[dir=rtl]_&]:translate-x-1/2", // Adjust translation based on direction
        ...
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:start-full group-data-[collapsible=offcanvas]:hover:bg-sidebar",
         // Adjust position based on side for offcanvas
    ...
    <main
      ...
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background",
         // Use ms/me for logical margin properties
    ...
    return (
      <Tooltip>
        <TooltipTrigger asChild>{button}</TooltipTrigger>
         {/* Use side="right" for LTR, adjust for RTL if needed */}
        <TooltipContent
          side="right"
          align="center"
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu-sub"
     // Use ms/ps for margin/padding start, border-s for border-start
    className={cn(
